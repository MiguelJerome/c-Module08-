...
public:
	...
	// Surcharge des opérateurs d'incrémentation et décrémentation
	Rationnel & operator++();											// ++ pré-incrémentation
	Rationnel operator++( int );										// ++ post-incrémentation
	Rationnel & operator--();											// -- pré-décrémentation
	Rationnel operator--( int );										// -- post-décrémentation
